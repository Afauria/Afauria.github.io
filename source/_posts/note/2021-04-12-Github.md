...
tags: 
- 笔记
description: GitHub笔记，Github访问不稳定解决
keywords: [github]
---
...
<img src="2021-04-12-GitHub/GitHub编辑器模式.png" alt="GitHub网页编辑器" style="zoom: 67%;" />
...
> Github上有牛人提供了脚本，一键获取github最新的IP，并更新hosts文件，clone下来，执行index.cmd即可：[setHost](https://github.com/luozheao/setHost)
