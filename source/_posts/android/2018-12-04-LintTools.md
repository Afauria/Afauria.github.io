...
![lint过程](/images/Lint/lint_process.png)
...
- 在Android Studio菜单栏Analyze>Inspect code，选择要扫描的范围（也可以在右键菜单中打开）
  ![android studio lint](/images/Lint/android_inspect01.png)
- 配置检查规则：
  ![android studio lint](/images/Lint/android_inspect02.png)
- 检查结果示例
  ![android studio lint](/images/Lint/android_inspect03.png)
...
- 配置规则
  ![配置规则](/images/Lint/lint_config.png)
- 前后对比
  - 编辑器里的提示对比
    ![配置前后对比](/images/Lint/lint_config01.png)
  - 导出结果对比
    ![配置前后对比](/images/Lint/lint_config02.png)
...
- 修改build.gradle如下
  ![自定义lint规则gradle配置](/images/Lint/custom_lint01.png)
...
2. 将jar放到模块libs目录，使用lintChecks方式引入
   ![lintChecks解释](/images/Lint/lintchecks.png)
