...
![AndroidDeviceMonitor打开](2021-12-12-Android性能分析-工具篇/Android性能分析工具演进.png)

## 工具作用

按照作用对工具进行下分类。区分下调试工具和性能分析工具

<img src="2021-12-12-Android性能分析-工具篇/Android性能分析工具分类.png" alt="AndroidDeviceMonitor打开" style="zoom:80%;" />
...
![AndroidDeviceMonitor打开](2021-12-12-Android性能分析-工具篇/AndroidDeviceMonitor打开.png)

界面如下：

![Android Device Monitor](2021-12-12-Android性能分析-工具篇/AndroidDeviceMonitor界面.png)

## 常用按钮介绍

![AndroidDeviceMonitor工具栏](2021-12-12-Android性能分析-工具篇/AndroidDeviceMonitor工具栏.png)
...
![TraceView界面](2021-12-12-Android性能分析-工具篇/TraceView界面.png)

TraceView时间轴窗格：每个线程的活动信息

![TraceView时间轴窗格](2021-12-12-Android性能分析-工具篇/TraceView时间轴窗格.png)

TraceView分析窗格：方法耗时和CPU使用信息

![TraceView分析窗格](2021-12-12-Android性能分析-工具篇/TraceView分析窗格.png)
...
![](2021-12-12-Android性能分析-工具篇/dmtracedump.png)
...
<img src="2021-12-12-Android性能分析-工具篇/DDMS-Systrace打开.png" style="zoom:67%;" />

选择输出路径、跟踪时长、Buffer大小、Tag等

<img src="2021-12-12-Android性能分析-工具篇/DDMS-Systrace.png" style="zoom:67%;" />
...
<img src="2021-12-12-Android性能分析-工具篇/Systrace卡顿帧.png" style="zoom:70%;" />
...
<img src="2021-12-12-Android性能分析-工具篇/AndroidMonitor界面.png" style="zoom: 67%;" />

## Android Profiler

Android Studio3.0及以上，包含CPU（可以进行卡顿检测）、Memory、Network、Energy能耗分析器

<img src="2021-12-12-Android性能分析-工具篇/AndroidProfiler界面.png" alt="AndroidProfiler界面" style="zoom: 40%;" />
...
<img src="2021-12-12-Android性能分析-工具篇/CPU Profiler.png" style="zoom:67%;" />
...
1. 对Java方法采样：间隔一段时间捕获应用调用堆栈，比较捕获的数据集，推导应用Java方法执行时间和资源使用情况。
   ...
   > 如果一个方法在间隔期间执行完毕，则可能不会被记录。对于这种生命周期较短的方法，应使用插桩跟踪

2. 跟踪Java方法：对每个Java方法调用开始和结束时记录时间戳。

   > 记录每个方法，会影响运行时性能，进而影响分析数据。另外也会造成生成文件过大。
...
<img src="2021-12-12-Android性能分析-工具篇/CPU Profiler分析窗格.png" style="zoom:67%;" />
...
<img src="2021-12-12-Android性能分析-工具篇/CPU Profiler卡顿分析.png" style="zoom:70%;" />
...
<img src="2021-12-12-Android性能分析-工具篇/Memory Profiler.png" style="zoom:67%;" />
...
<img src="2021-12-12-Android性能分析-工具篇/Memory Profiler堆信息.png" style="zoom:67%;" />
...
<img src="2021-12-12-Android性能分析-工具篇/Perfetto卡顿帧.png" style="zoom:70%;" />
...
1. 打开System Tracing应用："开发者选项>System Tracing"
   ...
   <img src="2021-12-12-Android性能分析-工具篇/System Tracing App.png" style="zoom:50%;" />
