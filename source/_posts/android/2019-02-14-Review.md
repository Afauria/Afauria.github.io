...
![Activity生命周期](/images/Review/ActivityLifecycler.png)
...
![Service生命周期官方图](/images/Review/ServiceLifecycle.png)

### 1.2.1. Service和Thread的区别
...
### 2.1.4. 使用Application退出：自行维护Activity列表
...
![Android系统架构](/images/Review/Android系统架构.jpg)
...
![Android打包流程](/images/Review/Android打包流程.jpg)
...
![自定义View绘制顺序](/images/Review/自定义View绘制顺序.jpg)
...
### 7.1.1. ThreadLocal：线程本地变量

每个线程各自拥有，互不影响。get到的值是不一样的

### 7.1.2. Handler机制（占个坑，有空补图）
