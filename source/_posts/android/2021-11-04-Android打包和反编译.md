...
* [jadx](https://github.com/skylot/jadx)：反编译dex、aar、aab、apk、资源等，可视化操作界面。支持导出Gradle工程。
...
> javap：将class字节码文件反汇编，用于查看java字节码，了解JVM指令执行过程。JVM汇编指令参考[官方文档](https://docs.oracle.com/javase/specs/jvms/se7/html/jvms-6.html#jvms-6.5)
>
> 有助于了解原理，如
>
> * java枚举
