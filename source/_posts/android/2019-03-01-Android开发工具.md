...
- `md5 [文件]`：获取文件md5值
- `appops set 包名 <SYSTEM_ALERT_WINDOW/READ_EXTERNAL_STORAGE> <allow/deny/ignore>`：权限设置
...
* 官方在Android Emulator 27.3.1上给出了解决方案，结合了Win10的Hyper-V技术。
  ...
  * 在控制面板->程序->启用或关闭Windows功能中，打开**Windows虚拟机监控程序平台（Windows Hypervisor Platform）**
  * 重启电脑
...
![Win10开启虚拟化技术](2019-03-01-Android开发工具/Win10开启虚拟化技术.png) 
