...
![](2022-08-19-冒险岛私服搭建v176/一键启动器.png)

高版本的客户端好像没法用原来的命令行指定端口号启动，需要用它带的登录器，点击上图的"游戏启动"

运行成功截图

![](2022-08-19-冒险岛私服搭建v176/运行成功截图.png)
...
<img src="2022-08-19-冒险岛私服搭建v176/反编译AuthCheckUtil.png" style="zoom:100%;" />
...
<img src="2022-08-19-冒险岛私服搭建v176/反编译checkMapleAuth.png" style="zoom:100%;" />
...
![修改checkMapleAuth返回值](2022-08-19-冒险岛私服搭建v176/修改checkMapleAuth返回值.png)

这里为了不修改校验的逻辑，我们再修改下`getProcessorId`的返回值

![修改getProcessorId返回值](2022-08-19-冒险岛私服搭建v176/修改getProcessorId返回值.png)

修改decode方法的返回值，`aload0`表示将传入的参数原封不动的返回。

> 全局搜了一下这个方法只用到了一次，因此不会影响到其他地方。如果被用到了就要换个地方修改，例如修改切割字符串的地方。

![修改decode方法返回值](2022-08-19-冒险岛私服搭建v176/修改decode返回值.png)
...
![](2022-08-19-冒险岛私服搭建v176/反编译StringUtil.png)
...
![](2022-08-19-冒险岛私服搭建v176/修改main方法.png)
...
![](2022-08-19-冒险岛私服搭建v176/IP地址转发.png)
...
![](2022-08-19-冒险岛私服搭建v176/Linux模拟wmic.png)
...
![](2022-08-19-冒险岛私服搭建v176/Linux上运行服务端卡住.png)
