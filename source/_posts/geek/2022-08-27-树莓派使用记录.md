...
3. 使用读卡器插入SD卡，打开烧录工具，选择操作系统、选择SD卡，烧录即可
4. 将SD卡插入树莓派，听说还要设置下地区和时区
...
1. 下载`jdk-8u251-linux-arm32-vfp-hflt.tar.gz`：看了一下已经有了，省去了下载的过程
...
1. HDMI需要先接线再开机，否则不会显示画面
2. 关机：`sudo halt && sudo shutdown && sudo poweroff`