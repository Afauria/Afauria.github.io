...
1. 渲染（绘制）：通过图形API接口绘制图形（包括软件/硬件加速，2D/3D，直接/间接，客户端渲染/服务端渲染），保存到Buffer中（操作内存MMIO、DMA）
...
由于**每个GUI应用都要显示界面，而显示设备只有一个**，因此需要为每个应用分配一个窗口，再对画面进行合成，最终输出到显示设备。
...
<img src="2022-02-12-图形系统/图形系统架构层级.png" style="zoom:100%;" />
...
* [xplain](https://magcius.github.io/xplain/article/)：XWindow介绍，包含大量演示案例
* [Wayland与Weston简介](https://blog.csdn.net/jinzhuojun/article/details/47290707)
* [X Window配置介绍](http://cn.linux.vbird.org/linux_basic/0590xwindow_1.php)：鸟哥的Linux私房菜
