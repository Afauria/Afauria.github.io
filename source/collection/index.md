...
| [RapitTables](https://www.rapidtables.com/)                  | 快速参考信息和工具                                           | https://www.rapidtables.com/                      |
...
| [Gityuan](http://gityuan.com/)                               | Android开发工程师                             |      |
...
| [彭旭锐的简书博客](https://www.jianshu.com/u/d9761b0d1618)   | Java和Android技术文章                         |      |
...
| [Material Design Colors](https://www.materialpalette.com/colors) | MaterialDesign调色板、图标等 |      |
...
| [APKNite](https://apknite.com/)                        | @Deprecated |                         |
| [ApkMirror](https://www.apkmirror.com/)                | @Deprecated |                         |
| [APKCombo](https://apkcombo.com/zh-cn/)                | @Deprecated |                         |
| [SameAPK](https://sameapk.com/)                        | @Deprecated |                         |
...
| [mobibrw默默的点滴](https://mobibrw.com/Android_10.0.0_r40/) | Android10源代码                                              |      |
...
2. Markdown会将语法转为静态html文件，直接在顶部添加`<style>`样式，通过开发者工具找到对应的标签，将html表格改为卡片样式。
