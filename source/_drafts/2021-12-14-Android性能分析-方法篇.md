...
<img src="2021-12-14-Android性能分析-方法篇/CPU分析大纲.png" style="zoom:67%;" />
...
<img src="2021-12-14-Android性能分析-方法篇/内存分析大纲.png" style="zoom:70%;" />
...
Android系统LMK机制（Low Memory Kill）在内存不足时，会根据进程adj值杀死进程。
...
1. 主线程做了太多阻塞耗时操作：例如I/O、Binder调用等
2. CPU和内存满载
...
分析：出现anr之后会在`/data/anr/`路径下生成anr trace文件。找到对应的进程pid，搜索`main`线程，查看anr堆栈。
