...
|[class-dump](http://stevenygard.com/projects/class-dump/) | 可以将Objective-C的二进制文件反编译出头文件 |
|[jadx](https://github.com/skylot/jadx)                        | 反编译apk，查看源码                  |
|[jd-gui](http://java-decompiler.github.io/)                   | 查看jar源码文件                      |
|[dex2jar](https://github.com/pxb1988/dex2jar)、[dex-tools](https://github.com/pxb1988/dex2jar/releases)                 | dex、smali、class互相转换 |
...
| 软件                                      | 说明                                               |
| ----------------------------------------- | -------------------------------------------------- |
| [Apifox](https://www.apifox.cn/)          | 支持API文档、接口请求、Mock、测试、协作等，个人版免费      |
| [Postman](https://www.postman.com/)       | API调试                                            |
| [YApi](https://hellosean1025.github.io/yapi/)       |    开源、可自行部署                              |
...
| [Swagger](https://swagger.io/tools/swagger-editor/)            | 海外客户用                                |
