...
| 软件                                                         | 说明                                 |
| ------------------------------------------------------------ | ------------------------------------ |
| [IDA](https://hex-rays.com/ida-free/)                        | 反汇编工具                           |
| [Hopper Disassembler](https://www.hopperapp.com/download.html) | 反汇编工具，试用版半小时需要重启一次 |
| jadx                                                         | 反编译apk，查看源码                  |
| jd-gui                                                       | 查看jar源码文件                      |
| dex2jar                                                      |                                      |
| apktool                                                      | 反编译apk                            |
...
| PsiViewer                              | Program Structure Interface，解析java文件结构，可以用Psi接口访问，类似ASM |
